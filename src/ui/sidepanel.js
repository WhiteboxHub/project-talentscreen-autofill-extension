...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const jsonInput = document.getElementById('resumeInput');
    const pdfInput = document.getElementById('resumeFileInput');
    ...
    if (jsonUploadBtn) {
        jsonUploadBtn.addEventListener('click', () => jsonInput.click());
    }
    if (uploadPdfBtn) {
    ...
    function populateCustomForm() {
        ...
        document.getElementById('gender').value = eeo.gender || '';
        document.getElementById('veteranStatus').value = eeo.veteran_status || '';
        document.getElementById('workAuthUs').value = legal.work_auth_us ? 'true' : 'false';
        document.getElementById('sponsorshipRequired').value = legal.sponsorship_required ? 'true' : 'false';
    }
    ...
    customForm.addEventListener('submit', (e) => {
        ...
        try {
            ...
            currentResumeData.custom_fields.legal.work_auth_us = document.getElementById('workAuthUs').value === 'true';
            currentResumeData.custom_fields.legal.sponsorship_required = document.getElementById('sponsorshipRequired').value === 'true';
    ...
    if (updatePdfBtn) {
        updatePdfBtn.addEventListener('click', () => updatePdfInput.click());
    }

    updateJsonInput.addEventListener('change', (e) => {
        handleUpdateJson(e.target.files[0]);
    });
